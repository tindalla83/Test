/* ==========================================================================
   Mallory — data + generative artwork
   ...
   no stock photography. Swap MALLORY.art.* for real photography when ready.
   ========================================================================== */
...
(function () {
  ...
  var products = [
    ...
    /* ---------------- THE CRATE ---------------- */
    P({ name: "The Fellside Crate", maker: "Mallory", collection: "the-crate", category: "Gifts", icon: "crate", price: 95, badges: ["gift", "most-gifted"], colorNames: ["Fell Green"],
    ...
    P({ name: "The Gentleman's Crate", maker: "Mallory", collection: "the-crate", category: "Gifts", icon: "crate", price: 110, badges: ["gift"], colorNames: ["Bilberry"],
    ...
    P({ name: "The Working Man's Crate", maker: "Mallory", collection: "the-crate", category: "Gifts", icon: "crate", price: 85, badges: ["gift"], colorNames: ["Bracken"],
    ...
    P({ name: "Build-Your-Own Crate", maker: "Mallory", collection: "the-crate", category: "Gifts", icon: "crate", price: 45, badges: ["gift", "new"], colorNames: ["Oat"],
    ...
    P({ name: "The Wild Swimmer's Crate", maker: "Mallory", collection: "the-crate", category: "Gifts", icon: "crate", price: 120, badges: ["gift", "new"], colorNames: ["Storm Blue"],
  ...
  var articles = [
    ...
    { id: "meet-the-maker-cumbria-bootworks", cat: "Maker Stories", title: "Meet the maker: Cumbria Bootworks", excerpt: "In a workshop outside Kendal, a small team still welts boots by hand — and will resole them for as long as you own them.", read: "7 min", date: "20 Aug 2026", motif: "boot",
      body: [
        ...
        "It's exactly the sort of quiet, stubborn quality Mallory was built to sell. Their Grafter boot is one of our most-gifted things, and we're not surprised."
      ] },
