...
(function () {
  ...
  function renderArticle() {
    ...
    document.title = a.title + " — Mallory Journal";
  ...
  function mountNewsletter() {
    ...
    form.addEventListener("submit", function (e) {
      ...
      note.textContent = "You’re on the list — welcome to Mallory. Check your inbox to confirm.";
